...
const Sidebar = ({ isSidebarOpen }) => {
  ...
  return (
    <div
      className={`${
        isSidebarOpen ? "flex absolute" : "hidden"
      } lg:flex lg:absolute top-0 left-0 right-0 flex-col col-span-2 items-start dark:bg-grey min-h-screen pt-16 pb-6 w-[240px] z-40 overflow-y-scroll scrollbar-hide`}>
      ...
      <SidebarRow
        ...
        title="Your videos"
        pathname="feed/my_videos"
      />
      <SidebarRow
        Icon={ThumbUpIcon}
        title="Liked videos"
        pathname="feed/liked_videos"
      />
      <hr className="border border-gray-3 w-full my-3" />
